...
const SAMPLE_AUDIO: Record<string, string> = {
  english: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3",
  arabic:  "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3",
};
